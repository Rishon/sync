...
import systems.rishon.sync.packet.ClientAddPlayerPacket
...
class ConnectPacket(
    ...
    override fun onReceive() {
        LoggerUtil.debug("Received connect packet for $playerUUID")
    ...
    private fun createFakePlayer(
        ...
        if (viewer != null && playerUUID != viewer.uniqueId) ClientAddPlayerPacket.sendPacket(viewer, fakePlayer)
